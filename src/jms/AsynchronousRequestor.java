...
public class AsynchronousRequestor<REQUEST, REPLY> {
    ...
    private class Pair {
        ...
        private ReplyListener<REQUEST, REPLY> listener;
        private REQUEST request;

        private Pair(ReplyListener<REQUEST, REPLY> listener, REQUEST request) {
     ...
     */
    private RequestReplySerializer<REQUEST, REPLY> serializer;
     ...
     */
    public AsynchronousRequestor(String requestSenderQueue, String replyReceiverQueue, RequestReplySerializer<REQUEST, REPLY> serializer)
            throws Exception {
     ...
     */
    public synchronized void sendRequest(REQUEST request, ReplyListener<REQUEST, REPLY> listener) throws JMSException {
