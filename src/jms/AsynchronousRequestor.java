...
public class AsynchronousRequestor<REQUEST, REPLY> {
    ...
    private class Pair {
        ...
        private final ReplyListener<REQUEST, REPLY> listener;
     ...
     */
    private final RequestReplySerializer<REQUEST, REPLY> serializer;
     ...
     */
    public synchronized void sendRequest(REQUEST request, ReplyListener<REQUEST, REPLY> listener)
            throws JMSException {
