...
abstract class ClientRequestProcess {
    ...
    private final ReplyListener<CreditRequest, CreditReply> creditReplyListener;
    private final ReplyListener<BankQuoteRequest, BankQuoteReply> bankReplyListener;
    ...
    public ClientRequestProcess(ClientRequest clientRequest, CreditGateway creditGateway, ClientGateway clientGateway, BankGateway bankGateway) {
        ...
        this.creditReplyListener = new ReplyListener<CreditRequest, CreditReply>() {
        ...
        this.bankReplyListener = new ReplyListener<BankQuoteRequest, BankQuoteReply>() {
     ...
     *
     * @todo Implement the following 1. call method notifyReceivedCreditReply to
     * add the CreditReply to the GUI 2. create the bankRequest from the
     * creditRequest (use method createBankRequest) 3. send the bankRequest and
     * register the method onBankQuoteReply as the listener for the reply
     */
