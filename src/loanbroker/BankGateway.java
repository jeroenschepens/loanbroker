...
import jms.ReceiverMessagingGateway;
import jms.SenderMessagingGateway;
...
public class BankGateway {
     ...
     * @param listener
     */
    public synchronized void sendRequest(BankQuoteRequest request, ReplyListener<BankQuoteRequest, BankQuoteReply> listener) {
        ...
        if (banksSend == 0) {
            BankQuoteReply reply = new BankQuoteReply(0, "NEIN!", 10);
