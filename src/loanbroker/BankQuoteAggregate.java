...
public class BankQuoteAggregate {
    ...
    private ReplyListener<BankQuoteRequest, BankQuoteReply> replyListener;

    BankQuoteAggregate(BankQuoteRequest request, int nrExpectedReplies, ReplyListener<BankQuoteRequest, BankQuoteReply> listener) {
